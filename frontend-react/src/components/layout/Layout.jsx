...
// Mobile layout (responsive sidebar) is out of scope — desktop-first (1280px+).
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '232px 1fr', height: '100vh', background: 'var(--bg)', color: 'var(--text)', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', padding: '24px 28px 60px', maxWidth: '1640px', width: '100%', margin: '0 auto' }}>
          <Outlet />
        </main>
      </div>
    </div>
